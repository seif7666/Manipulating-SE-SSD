...
model = dict(
    type="VoxelNet",
    pretrained=None,
    reader=dict(type="vfe", in_channels=7, out_channels=7, norm_cfg=norm_cfg,),
...
train_anno = '/content/drive/MyDrive/Graduation_Project/ObjectDetection3D/data_object_velodyne/kitti_infos_train.pkl'
